...
sub new {
	...
	$self->{'scales'} = {
		...
		'ReverseViridis'=> {'str'=>'rgb(253,231,36) 0%, rgb(186,222,39) 10%, rgb(121,209,81) 20%, rgb(66,190,113) 30%, rgb(34,167,132) 40%, rgb(32,143,140) 50%, rgb(41,120,142) 60%, rgb(52,94,141) 70%, rgb(64,67,135) 80%, rgb(72,35,116) 90%, rgb(68,1,84) 100%'},
